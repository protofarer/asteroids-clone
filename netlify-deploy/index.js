...
Module['FS_createPath']("/assets", "audio", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/audio/beat-hi.wav", "start": 0, "end": 22500, "audio": 1}, {"filename": "/assets/audio/beat-low.wav", "start": 22500, "end": 50374, "audio": 1}, {"filename": "/assets/audio/damage-ship.wav", "start": 50374, "end": 61995, "audio": 1}, {"filename": "/assets/audio/destroy-asteroid.wav", "start": 61995, "end": 92299, "audio": 1}, {"filename": "/assets/audio/moderate-thud.wav", "start": 92299, "end": 104988, "audio": 1}, {"filename": "/assets/audio/physical-death.wav", "start": 104988, "end": 182478, "audio": 1}, {"filename": "/assets/audio/physical-harm.wav", "start": 182478, "end": 185987, "audio": 1}, {"filename": "/assets/audio/proj-core.wav", "start": 185987, "end": 188415, "audio": 1}, {"filename": "/assets/audio/score.wav", "start": 188415, "end": 196923, "audio": 1}, {"filename": "/assets/audio/shot-light.wav", "start": 196923, "end": 202004, "audio": 1}, {"filename": "/assets/audio/shot-tiny.wav", "start": 202004, "end": 203307, "audio": 1}, {"filename": "/assets/audio/thrust.wav", "start": 203307, "end": 221019, "audio": 1}, {"filename": "/assets/audio/ufo-alarm.wav", "start": 221019, "end": 417997, "audio": 1}], "remote_package_size": 417997});

  })();

// end include: /tmp/tmpbxmmh9zr.js
// include: /tmp/tmp8y6ip1cv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8y6ip1cv.js
// include: /tmp/tmpise9eh6x.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpise9eh6x.js
...
var ASM_CONSTS = {
  159344: () => { if (document.fullscreenElement) return 1; },  
 159390: () => { return document.getElementById('canvas').width; },  
 159442: () => { return parseInt(document.getElementById('canvas').style.width); },  
 159510: () => { document.exitFullscreen(); },  
 159537: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 159610: () => { if (document.fullscreenElement) return 1; },  
 159656: () => { return document.getElementById('canvas').width; },  
 159708: () => { return screen.width; },  
 159733: () => { document.exitFullscreen(); },  
 159760: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 159893: () => { return window.innerWidth; },  
 159919: () => { return window.innerHeight; },  
 159946: () => { if (document.fullscreenElement) return 1; },  
 159992: () => { return document.getElementById('canvas').width; },  
 160044: () => { return parseInt(document.getElementById('canvas').style.width); },  
 160112: () => { if (document.fullscreenElement) return 1; },  
 160158: () => { return document.getElementById('canvas').width; },  
 160210: () => { return screen.width; },  
 160235: () => { return window.innerWidth; },  
 160261: () => { return window.innerHeight; },  
 160288: () => { if (document.fullscreenElement) return 1; },  
 160334: () => { return document.getElementById('canvas').width; },  
 160386: () => { return screen.width; },  
 160411: () => { document.exitFullscreen(); },  
 160438: () => { if (document.fullscreenElement) return 1; },  
 160484: () => { return document.getElementById('canvas').width; },  
 160536: () => { return parseInt(document.getElementById('canvas').style.width); },  
 160604: () => { document.exitFullscreen(); },  
 160631: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 160689: () => { return screen.width; },  
 160714: () => { return screen.height; },  
 160740: () => { return window.screenX; },  
 160767: () => { return window.screenY; },  
 160794: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 160847: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 160918: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 160975: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 161231: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 161302: () => { if (document.fullscreenElement) return 1; },  
 161348: () => { return window.innerWidth; },  
 161374: () => { return window.innerHeight; },  
 161401: () => { if (document.pointerLockElement) return 1; },  
 161448: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 163606: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 163770: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 163874: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 164045: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 166873: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 166939: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 167332: ($0) => { miniaudio.untrack_device_by_index($0); },  
 167375: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 167500: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
